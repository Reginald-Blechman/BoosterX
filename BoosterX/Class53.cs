...
{
	// Token: 0x0600042E RID: 1070 RVA: 0x000357D8 File Offset: 0x000339D8
	public static byte[] smethod_0(Array array_0, Struct18 struct18_0, Func<byte[]> func_0)
	{
		if (array_0 == null)
		{
			return null;
		...
		if (num3 > 0)
		{
			...
			for (int i = 0; i < num3; i++)
			{
				...
				Class119.smethod_0(array, num2, struct18_0.int_0);
				Class119.smethod_0(array, num2 + 4, struct18_0.int_1);
				Class119.smethod_0(array, num2 + 8, struct18_0.int_2);
				Class119.smethod_0(array, num2 + 12, struct18_0.int_3);
				num2 += 16;
			}
		}
		if (num2 < num)
		...
		if (num8 > 0)
		{
			...
			Class119.smethod_1(array, num2, struct18_0.int_0);
		}
		if (array5 != null)
		{
	...
	// Token: 0x0600042F RID: 1071 RVA: 0x00035AB4 File Offset: 0x00033CB4
	public static T[] smethod_1<T>(byte[] byte_0, int int_0, Struct18 struct18_0, Func<byte[]> func_0, bool bool_0)
	{
		if (byte_0 == null)
		{
			return null;
		...
		if (num3 > 0)
		{
			...
			for (int i = 0; i < num3; i++)
			{
				...
				Class119.smethod_0(array2, 0, struct18_0.int_0);
				Class119.smethod_0(array2, 4, struct18_0.int_1);
				Class119.smethod_0(array2, 8, struct18_0.int_2);
				Class119.smethod_0(array2, 12, struct18_0.int_3);
				int num4 = 0;
				int num5 = 0;
				if (array4 == array)
				{
		...
		if (num8 > 0)
		{
			...
			Class119.smethod_1(array2, 0, struct18_0.int_0);
		...
		{
			Class53.smethod_2<T>(array);
		}
		return array;
	}

	// Token: 0x06000430 RID: 1072 RVA: 0x00035DEC File Offset: 0x00033FEC
	private static void smethod_2<T>(T[] gparam_0)
	{
		...
		for (int i = 0; i < gparam_0.Length; i++)
		{
			...
			if (typeof(T) == typeof(float) && !Struct19.bool_0)
			{
				gparam_0[i] = (T)((object)Class11.smethod_6(array, 0));
			}
			else if (typeof(T) == typeof(double) && !Struct8.bool_0)
			{
				gparam_0[i] = (T)((object)Class11.smethod_7(array, 0));
			}
			else
			{
